...
export const validateUserExists = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
  try {
...
export const rateLimit = (req: AuthRequest, res: Response, next: NextFunction): void => {
